export default {
  ...
  'typography.reading_mode.auto': 'Follow Device (Chapter Scroll on Mobile)',
  'typography.reading_mode.paginated': 'Paginated',
  'typography.reading_mode.scrolled': 'Vertical Chapter Scroll',
  ...
  'settings.status_bar.title': 'Display Mode',
  'settings.status_bar.description':
    'System mode shows the Android status bar. Immersive mode hides it and fills the screen with content. Time and battery can be placed in the reader header or footer below.',
  'settings.status_bar.system': 'System mode',
  'settings.status_bar.immersive': 'Immersive mode',
  ...
  'settings.reader_meta.option.pageNumber': 'Chapter Page & Name',
  'settings.reader_meta.option.globalPage': 'Whole-book Page',
  'settings.reader_meta.option.href': 'Current Section',
  'settings.reader_meta.option.progress': 'Reading Progress',
  'settings.reader_meta.option.time': 'Time',
  'settings.reader_meta.option.battery': 'Battery',
