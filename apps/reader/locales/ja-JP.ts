export default {
  ...
  'typography.double_page.page_margin_top': '単ページ上余白',
  'typography.double_page.page_margin_right': '単ページ右余白',
  'typography.double_page.page_margin_bottom': '単ページ下余白',
  'typography.double_page.page_margin_left': '単ページ左余白',
