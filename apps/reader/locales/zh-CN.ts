export default {
  ...
  'home.import': '导入',
  'home.import_device': '从设备导入 EPUB',
  'home.import_link': '从链接导入',
  'home.import_first_book': '导入第一本书',
  'home.empty_title': '书库还是空的',
  'home.empty_description': '点击右上角加号，从设备或链接导入 EPUB。',
  'home.selected': '本已选择',
  'home.delete': '删除',
  ...
  'typography.reading_mode.auto': '跟随设备（手机章节滚动）',
  'typography.reading_mode.paginated': '分页翻阅',
  'typography.reading_mode.scrolled': '章节内竖向滚动',
  ...
  'settings.status_bar.title': '屏幕显示模式',
  'settings.status_bar.description':
    '系统模式显示 Android 状态栏；沉浸模式隐藏系统栏并让内容铺满屏幕。时间和电量可在下方页眉页脚中选择。',
  'settings.status_bar.system': '系统模式',
  'settings.status_bar.immersive': '沉浸模式',
  ...
  'settings.reader_meta.option.pageNumber': '本章页码（含章节名）',
  'settings.reader_meta.option.globalPage': '全书页码',
  'settings.reader_meta.option.href': '当前段落位置',
  'settings.reader_meta.option.progress': '阅读进度',
  'settings.reader_meta.option.time': '时间',
  'settings.reader_meta.option.battery': '电量',
