export default {
  ...
  'typography.double_page.page_margin_top': '单页上边距',
  'typography.double_page.page_margin_right': '单页右边距',
  'typography.double_page.page_margin_bottom': '单页下边距',
  'typography.double_page.page_margin_left': '单页左边距',
